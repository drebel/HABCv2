    ...
    return(
        <fieldset key={props.questionKey}>
                    ...
                    <input
                        ...
                        />  
                    <label className="btn btn-outline-primary m-1 p-3" htmlFor={`${props.name}_none`}>
                        Not At All
                        ...
                        <input 
                            ...
                            onChange={props.handleChange}
                         />
                    <label className="btn btn-outline-primary m-1 p-3" htmlFor={`${props.name}_several`}>
                        Serveral Days 
                        ...
                        <input 
                            ...
                            onChange={props.handleChange}
                         />
                    <label className="btn btn-outline-primary m-1 p-3" htmlFor={`${props.name}_over`}>
                        Over half the days
                        ...
                        <input
                            ...
                            onChange={props.handleChange}
                         />
                    <label className="btn btn-outline-primary m-1 p-3" htmlFor={`${props.name}_daily`}>
                        Almost Daily
