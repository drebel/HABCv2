...
export default function Header(props){
  ...
  async function addGuestScore(user){
    ...
    try{
      const newDocValues = {
        createdBy: user.uid,
        rawScores: guestScore.rawScores,
  ...
  return (
    <header>
      <nav className="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom px-3">
        <div className="col-md-3 mb-2 mb-md-0">
          <Link to='/' className="d-flex flex-column link-body-emphasis text-decoration-none align-items-start">
            <p className='fw-bold lead mb-0'>HABC Web</p>
            <p className='font-italic text-secondary mb-0'>version 0.2.0</p>
          </Link>
        ...
        <div className="col-md-3 text-end">
          ...
          {props.showLogin && <Login 
            ...
            addGuestScore={addGuestScore}
          />}
          {props.showSignup && <Signup 
